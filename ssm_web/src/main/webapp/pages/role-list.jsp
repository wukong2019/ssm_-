			...
			<!-- 内容头部 /-->
				...
				<div class="box box-primary">
					...
					<div class="box-footer">
							...
							<div class="form-group form-inline">
								...
								<select class="form-control" id="changePageSize" onchange="changePageSize()">
									<c:forEach begin="1" end="5" var="pagesize">
										<option value="${pagesize}" <c:if test="${roleList.pageSize==pagesize}">selected</c:if>>${pagesize}</option>
									</c:forEach>
								</select> 条
							</div>
						</div>
						...
						<div class="box-tools pull-right">
							<ul class="pagination">
								<li><a href="${pageContext.request.contextPath}/role/findAll.do?page=1&size=${roleList.pageSize}" aria-label="Previous">首页</a></li>
								<li><a href="${pageContext.request.contextPath}/role/findAll.do?page=${roleList.pageNum-1}&size=${roleList.pageSize}">上一页</a></li>
								<c:forEach begin="1" end="${roleList.pages}" var="pagenum">
									<li><a href="${pageContext.request.contextPath}/role/findAll.do?page=${roleList.pageNum}&size=${roleList.pageSize}">${pagenum}</a></li>
								</c:forEach>
								<li><a href="${pageContext.request.contextPath}/role/findAll.do?page=${roleList.pageNum+1}&size=${roleList.pageSize}">下一页</a></li>
								<li><a href="${pageContext.request.contextPath}/role/findAll.do?page=${roleList.pages}&size=${roleList.pageSize}" aria-label="Next">尾页</a></li>
							</ul>
						</div>
